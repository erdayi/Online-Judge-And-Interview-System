...
import type { QuestionAIGenerateRequest } from '../models/QuestionAIGenerateRequest';
...
questionAddRequest: QuestionAddRequest,
    ...
    /**
     * aiGenerateQuestion
     * @param questionAiGenerateRequest questionAIGenerateRequest
     * @returns BaseResponse_boolean_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static aiGenerateQuestionUsingPost(
questionAiGenerateRequest: QuestionAIGenerateRequest,
): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/ai/generate/question',
            body: questionAiGenerateRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
