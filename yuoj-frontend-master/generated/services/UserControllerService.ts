...
userAddRequest: UserAddRequest,
     ...
     * @throws ApiError
     */
    public static addUserSignInUsingPost(): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
...
id?: number,
     ...
     * @throws ApiError
     */
    public static getUserSignInRecordUsingPost(
year?: number,
): CancelablePromise<BaseResponse_List_int_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
